<%@ Page Title="" Language="C#" MasterPageFile="~/crud/indexProduct.Master" AutoEventWireup="true" CodeBehind="updateProduct.aspx.cs" Inherits="Tarea2Bases.crud.product.UpdateProduct" %>

<asp:Content ID="ContentUpdateProduct" ContentPlaceHolderID="ContentUpdateProduct" runat="server">
    <form action="" class="form-horizontal" runat="server">
            ...
            <div class="form-group has-success">
				...
				<div class="col-md-4">
                    <asp:TextBox ID="txtLoadProd" AutoComplete="off" class="form-control" type="text" placeholder="Producto" runat="server"></asp:TextBox>
				</div>
			</div>
            <div class="form-group">
				<!-- col-md-offset-2 acomoda el elemento a la derecha dos columnas -->
				<div class="col-md-2 col-md-offset-2">
                    <asp:Button ID="btnLoad" class="btn btn-success" runat="server" Text="Cargar datos" OnClick="btnLoad_Click" />
				</div>
			</div>
