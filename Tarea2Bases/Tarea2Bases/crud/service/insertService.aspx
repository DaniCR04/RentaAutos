<%@ Page Title="" Language="C#" MasterPageFile="~/crud/indexService.Master" AutoEventWireup="true" CodeBehind="insertService.aspx.cs" Inherits="Tarea2Bases.crud.service.InsertService" %>

<asp:Content ID="ContentInsertService" ContentPlaceHolderID="ContentInsertService" runat="server">
		...
		<!-- <fieldset disabled> : Desabilita todos los componentes dentro del formulario-->
			...
			<div class="form-group">
				...
				<div class="col-md-2 col-md-offset-2">
                    <asp:Button ID="btnSend" class="btn btn-success" runat="server" Text="Insertar" OnClick="btnSend_Click" />
				</div>
			</div>
