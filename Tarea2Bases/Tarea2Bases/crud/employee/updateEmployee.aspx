<%@ Page Title="" Language="C#" MasterPageFile="~/crud/indexEmployee.Master" AutoEventWireup="true" CodeBehind="updateEmployee.aspx.cs" Inherits="Tarea2Bases.crud.employee.UpdateEmployee" %>

<asp:Content ID="ContentUpdateEmployee" ContentPlaceHolderID="ContentUpdateEmployee" runat="server">
    <form action="" class="form-horizontal" runat="server">
        ...
        <div class="form-group has-success">
		    ...
		    <div class="col-md-4">
                <asp:TextBox ID="txtLoadEmp" AutoComplete="off" class="form-control" type="text" placeholder="Cédula" runat="server"></asp:TextBox>
		    </div>
	    </div>
        <div class="form-group">
		    <!-- col-md-offset-2 acomoda el elemento a la derecha dos columnas -->
		    <div class="col-md-2 col-md-offset-2">
                <asp:Button ID="btnLoadEmp" class="btn btn-success" runat="server" Text="Cargar datos" OnClick="btnLoadEmp_Click" />
		    </div>
	    </div>
