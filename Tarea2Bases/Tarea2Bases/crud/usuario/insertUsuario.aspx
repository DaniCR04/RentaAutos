<%@ Page Title="" Language="C#" MasterPageFile="~/crud/indexUsuario.Master" AutoEventWireup="true" CodeBehind="insertUsuario.aspx.cs" Inherits="Tarea2Bases.crud.usuario.insertUsuario" %>

<asp:Content ID="ContentInsertUsuario" ContentPlaceHolderID="ContentInsertUsuario" runat="server">
    ...
    <form action="" class="form-horizontal" runat="server">
		<!-- <fieldset disabled> : Desabilita todos los componentes dentro del formulario-->
            ...
            <div class="form-group has-success">
				...
				<div class="col-md-4">
                    <asp:TextBox ID="TextfechaRegistro" AutoComplete="off" class="form-control" type="text" placeholder="fechaRegistro" runat="server"></asp:TextBox>
				</div>
			</div>
